...
class StartupCreationTestCase(TestCase):
    ...
    def setUp(self):
        ...
        UserStartup.objects.create(customuser=self.user,
                                   startup=self.startup,
                                   startup_role_id=1)
        UserRoleCompany.objects.create(user=self.user,
                                       role='startup',
                                       company_id=self.startup.id)
        ...
        UserInvestor.objects.create(customuser=self.investor_user,
                                    investor=self.investor_profile,
                                    investor_role_id=1)
        UserRoleCompany.objects.create(user=self.investor_user,
                                       role='investor',
                                       company_id=self.investor_profile.id)
